          ...
          <Container className="py-20 md:py-28">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {tiers.map((t, i) => (
                <div
                  key={t.name}
                  className={`flex flex-col rounded-sm border bg-white/5 card-subtle p-8 card-hover ${
                    t.highlight
                ...
                >
                  ...
                  <p className="label-mono mt-2 text-white/60">{t.deploy}</p>
            ...
            <div className="mt-12 grid gap-8 md:grid-cols-3">
              {[
                ...
                },
                {
                 ...
                 <div key={s.step} className="rounded-sm border border-white/10 bg-white/5 card-subtle p-8 card-hover">
        ...
        <section className="border-b border-white/10 bg-white/5">
          <Container className="py-20 md:py-28">
            ...
            <div className="mt-12 space-y-6">
              {faqs.map((f) => (
                 <div key={f.q} className="rounded-sm border border-white/10 bg-white/5 card-subtle p-6 card-hover md:p-8">
