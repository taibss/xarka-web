...
function EnergyPage() {
  const useCases = [
    {
      t: "Sovereign intelligence systems",
      d: "Air-gapped, self-hosted AI for sensitive operating environments.",
    },
    {
      t: "Private model deployment",
      d: "Run inference and reasoning on your infrastructure with no external calls.",
    },
    {
      t: "Asset monitoring",
      d: "Real-time monitoring of critical energy infrastructure — pipelines, grids, refineries.",
    },
    {
      t: "Incident response",
      d: "Automated detection and escalation of safety and operational incidents.",
    },
    {
      t: "Compliance automation",
      d: "Automated regulatory reporting and audit trail generation for defence and energy sectors.",
    },
  ];
          ...
          <section className="border-b border-white/5">
            <Container className="py-16 md:py-24">
              ...
              <p className="mt-6 max-w-2xl text-white/50 md:text-lg">
                Energy, hydrocarbon, and defence organisations cannot send sensitive data to
                external models, foreign clouds, or uncontrolled third-party APIs. Xarka builds AI
                systems that run entirely within your control.
              </p>
