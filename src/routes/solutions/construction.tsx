...
function ConstructionPage() {
  const useCases = [
    { t: "PPE detection", d: "Real-time monitoring of helmet, vest, and safety gear compliance across sites." },
    { t: "Site progress monitoring", d: "Track construction progress against BIM models and project schedules." },
    { t: "Occupancy & flow", d: "Monitor worker density, traffic patterns, and zone utilisation for safety and efficiency." },
    { t: "Delay risk", d: "Predict schedule slippage from site data, weather, and supply chain signals." },
    { t: "Drawing & spec search", d: "Instant retrieval of relevant drawings, specifications, and change orders." },
    { t: "Contractor documentation", d: "Automate compliance reports, daily logs, and material tracking." },
    { t: "Safety reporting", d: "Automated incident detection, near-miss logging, and safety audit preparation." },
  ];
        ...
        <section className="border-b border-hairline">
          <Container className="py-16 md:py-24">
            ...
            <p className="mt-6 max-w-2xl text-steel md:text-lg">
              Construction sites generate enormous data — camera feeds, progress photos, safety reports,
              drawings, RFIs, and daily logs. Most of it never reaches a decision-maker in time.
            </p>
