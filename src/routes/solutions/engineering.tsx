...
function EngineeringPage() {
  const useCases = [
    { t: "Drawing intelligence", d: "Search, retrieve, and reason over P&IDs, schematics, and engineering drawings." },
    { t: "Specification search", d: "Instant lookup of material specs, tolerances, and design standards across projects." },
    { t: "Test report analysis", d: "Automated extraction of key findings, non-conformances, and trends from test data." },
    { t: "Design history review", d: "Trace design decisions, revisions, and approvals across the full project lifecycle." },
    { t: "Compliance verification", d: "Cross-check designs and reports against regulatory standards and internal requirements." },
  ];
      ...
      <main>
        ...
        <section className="border-b border-hairline">
          <Container className="py-16 md:py-24">
            ...
            <p className="mt-6 max-w-2xl text-steel md:text-lg">
              Engineering teams work with drawings, P&IDs, specifications, test reports, and design
              histories that span years and thousands of documents. Xarka makes them instantly searchable
              and reasoning-ready.
            </p>
        ...
        <section className="border-b border-hairline bg-paper-soft">
          <Container className="py-20 md:py-28">
            ...
            <p className="mt-6 max-w-2xl text-steel md:text-lg">
              Engineering documents are proprietary and sensitive. Xarka deploys on-prem or in your
              private cloud — your design data never leaves your infrastructure.
            </p>
          </Container>
        </section>
        </ScrollReveal>
