...
function InfrastructurePage() {
  const useCases = [
    {
      t: "Traffic & road monitoring",
      d: "Real-time traffic flow analysis, incident detection, and congestion prediction.",
    },
    {
      t: "CCTV analytics",
      d: "Intelligent surveillance — anomaly detection, crowd monitoring, perimeter security.",
    },
    {
      t: "Asset maintenance",
      d: "Predictive maintenance for bridges, roads, water systems, and public utilities.",
    },
    {
      t: "Incident detection",
      d: "Automated detection of accidents, hazards, and unusual activity from live feeds.",
    },
    {
      t: "Public grievance workflows",
      d: "AI-triaged citizen complaint routing, status tracking, and resolution tracking.",
    },
    {
      t: "Project progress monitoring",
      d: "Track infrastructure project milestones against timelines using site data.",
    },
    {
      t: "Document automation",
      d: "Automate generation of compliance reports, project updates, and regulatory filings.",
    },
  ];
          ...
          <section className="border-b border-white/5">
            <Container className="py-16 md:py-24">
              ...
              <p className="mt-6 max-w-2xl text-white/50 md:text-lg">
                Public infrastructure generates massive data — CCTV feeds, sensor networks,
                maintenance logs, citizen requests, and project reports. Xarka turns this into
        ...
        <ScrollReveal>
          <section className="border-b border-white/[0.06] bg-white/[0.02]">
            <Container className="py-20 md:py-28">
              ...
              <p className="mt-6 max-w-2xl text-white/50 md:text-lg">
                Government and public-sector infrastructure demands sovereign deployment. Xarka runs
                on-prem or in air-gapped environments — your data never leaves your control.
              </p>
            </Container>
          </section>
        </ScrollReveal>
