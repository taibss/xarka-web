          ...
          <Container className="py-16 md:py-24">
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              {["citation-grounded", "source-linked", "review-first", "auditable", "context-aware"].map((tag) => (
                <span key={tag} className="label-mono rounded-sm border border-white/10 bg-white/5 px-2.5 py-1.5 text-white/60">
                  {tag}
                </span>
              ))}
            </div>
        ...
        <section className="border-b border-white/10 bg-white/5">
          <Container className="py-20 md:py-28">
            ...
            <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {features.map((f) => (
                <div key={f.t} className="rounded-sm border border-white/10 bg-white/5 card-subtle p-6 card-hover">
                  <h3 className="font-serif text-lg text-white">{f.t}</h3>
        ...
        <section className="border-b border-white/10">
          <Container className="py-20 md:py-28">
            ...
            <div className="mt-12 flex flex-wrap gap-3">
              {trustPoints.map((t) => (
                <div key={t} className="rounded-sm border border-white/10 bg-white/5 card-subtle px-5 py-3 font-serif text-white card-hover">
                  {t}
                </div>
              ))}
            </div>
        ...
        <section className="border-b border-white/10 bg-white/5">
          <Container className="py-20 md:py-28">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {personas.map((p) => (
                <div key={p.title} className="rounded-sm border border-white/10 bg-white/5 card-subtle p-8 card-hover">
          ...
          <Container className="py-20 md:py-28">
            ...
            <div className="mt-8 rounded-sm border border-white/10 bg-white/5 p-6">
              <div className="aspect-[16/10] w-full rounded-sm bg-ink/5 flex items-center justify-center">
                <span className="label-mono text-white/30">LawgicHub product screenshot</span>
              </div>
            </div>
            <div className="mt-12 grid items-stretch gap-6 md:grid-cols-2">
              <div className="flex flex-col rounded-sm border border-white/10 bg-white/5 card-subtle p-8 card-hover">
                <div className="label-mono text-copper">Live metrics</div>
                <div className="mt-6 flex-1 grid grid-cols-2 gap-6 content-start">
                  <div>
                    <div className="tabular font-serif text-3xl text-white">10,000+</div>
                    <div className="label-mono mt-1">Active lawyers</div>
                  </div>
                  <div>
                    <div className="tabular font-serif text-3xl text-white">9L+</div>
                    <div className="label-mono mt-1">Judgments</div>
                  </div>
                  <div>
                    <div className="tabular font-serif text-3xl text-white">₹99</div>
                    <div className="label-mono mt-1">Entry price</div>
                  </div>
                  <div>
                    <div className="tabular font-serif text-3xl text-white">Feb '26</div>
          ...
          <Container className="py-24 md:py-32">
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-sm border border-white/30 px-6 py-3.5 text-sm font-medium text-white hover:bg-white/10 hover:text-white transition-colors"
              >
